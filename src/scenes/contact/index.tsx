  ...
  return (
    <section id='contact' className="mx-auto w-5/6 pt-24 pb-32">
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Contact)}>
            ...
            >
                <HText>
                    <span className="text-primary-500">SIGN UP</span> TODAY TO ACHIEVE YOUR FITNESS GOALS
                </HText>
                <p className="my-5">
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    <form
                        target="_blank"
                        onSubmit={onSubmit}
                        action="https://formsubmit.co/5ea8c8df49b8aab8020cca5b079ec70c"
                        method="POST"
                    >
                    ...
                    {errors.email && (
                        <p className="mt-1 text-primary-500">
                            ...
                            {errors.email.type === "pattern" && "Invalid emai."}
                        </p>
                    )}
